...
* [ ] **[Despacho Escalonado y Ciclo de Vida Independiente por Equipo (Spec 35)]:** Desacoplamiento de macro-estado de OT vs micro-estado operacional por equipo (`tpry_rel_equipo` / `tequ_log_desplazamiento`), salida de patio asíncrona por máquina, elevación automática del proyecto a Ejecución con el 1er equipo activo, continuidad aislada de horómetros/días en Report Diario y semáforos por fila en la Torre de Control.
