...
// Middleware de inyección de Tenant Multiempresa
app.use((req, res, next) => {
  if (!req.user) {
    req.user = { id_empresa: 9 };
  }
  next();
});
...
app.use('/lg-gsp/api/proyectos', proyectosRoutes);

// Módulos: Inventario (WMS-Lite) y Mantenimiento (OTs)
