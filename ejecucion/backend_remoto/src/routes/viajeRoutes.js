...
// 1. Acceso Móvil por Usuario (PWA)
router.get('/usuario/activo', viajeController.getViajeActivo);

// 2. Acceso Móvil por Token (Público / PWA)
...
// 3. Gestión desde CRM / Torre de Control
