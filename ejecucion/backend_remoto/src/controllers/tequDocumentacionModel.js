...
class TequDocumentacionModel {
    ...
    async createDocumentacion(data) {
        ...
        try {
            ...
            const sqlInsert = `
          INSERT INTO sch_leansurvey_dev.TEQU_DOCUMENTACION_EQUIPO (
            id_equipo,
            registro_acreditacion,
            fecha_ult_calibracion,
            fecha_prox_calibracion,
        ...
        `;
            ...
            if (checkResult.rowCount > 0) {
                ...
                await client.query(
                    "UPDATE sch_leansurvey_dev.TEQU_EQUIPO SET estado = 'Cerrado' WHERE id_equipo = $1",
                    [id_equipo]
                );
            }
    ...
    async updateDocumentacion(id_doc, data) {
        ...
        try {
            ...
            const sqlUpdate = `
          UPDATE sch_leansurvey_dev.TEQU_DOCUMENTACION_EQUIPO
          SET
