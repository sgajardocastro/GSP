<template>
  <div class="checklist-camion-rampla-dmh">
...
const groups = [
  {
    ...
    mode: 'sino',
    items: [
      item('1.1', 'Documentacion del Camion')
    ]
  },
  {
    key: 'identificacion',
  ...
  },
  {
    ...
    items: [
      ...
      item('4.6', 'Seguro de quinta rueda')
    ]
  },
  {
    key: 'esp',
  ...
  },
  {
    ...
    items: [
      ...
      item('7.8', 'Camara de Retroceso (critico)'),
      item('7.9', 'Marcador de temperatura (critico)'),
      item('7.10', 'Marcador de combustible')
    ]
  },
  {
    key: 'seguridadPasiva',
  ...
  },
  {
    ...
    items: [
      ...
      item('11.2', 'Nivel de Adblue'),
      item('11.3', 'Corta corriente (critico)'),
      item('11.4', 'Parada de emergencia (critico)'),
      item('11.5', 'Parachoques'),
      item('11.6', 'Portalones, pilares y seguros'),
      item('11.7', 'Peldanos acceso cabina'),
      item('11.8', 'Escala Acceso a Plataforma'),
      item('11.9', 'Mangueras'),
      item('11.10', 'Carroceria en general')
    ]
  },
  {
    key: 'direccion',
...
.checklist-camion-rampla-dmh :deep(.v-field) {
  background: rgba(2, 6, 23, 0.56) !important;
  border-radius: 8px;
}

.checklist-camion-rampla-dmh :deep(.v-field__outline) {
  color: rgba(148, 163, 184, 0.48) !important;
}

.checklist-camion-rampla-dmh :deep(.v-label),
.checklist-camion-rampla-dmh :deep(.v-field__input),
.checklist-camion-rampla-dmh :deep(input),
.checklist-camion-rampla-dmh :deep(textarea) {
