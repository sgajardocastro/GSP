...
const defaultItems = [
  ...
  'Enchufe se encuentra en buen estado y embutido en el cable de alimentacion?',
  'La carcasa se encuentra limpia y en buen estado, es decir, libre de trizaduras, grasa, pintura o danos estructurales evidentes?',
  'El seguro de cuna o cincel, se encuentra operativo y en buenas condiciones?',
  'Interruptor de partida se encuentra operativo?',
  'Los mangos o punos de agarre, se encuentran firmes y en buen estado?',
  'El o los cinceles, se encuentran en buen estado, es decir sin desgaste excesivo o dano visible.',
...
function getDaySegmentTitle(dayName) {
  return `Checkeo Martillo Demoledor (${dayName})`
}
